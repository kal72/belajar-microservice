...
func (c *testService) Hello(ctx context.Context, in *HelloRequest, opts ...client.CallOption) (*HelloResponse, error) {
...
func RegisterTestHandler(s server.Server, hdlr TestHandler, opts ...server.HandlerOption) {
	...
	h := &testHandler{hdlr}
	s.Handle(s.NewHandler(&Test{h}, opts...))
}
...
func (h *testHandler) Hello(ctx context.Context, in *HelloRequest, out *HelloResponse) error {
